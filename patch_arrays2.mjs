...
// Find the start of companies and the start of domains
const compStart = content.indexOf('const companies:');
const compEnd = content.indexOf('const domains:', compStart);
const domStart = compEnd;
const domEnd = content.indexOf('export const LandingPage:', domStart);
...
content = content.substring(0, compStart) + newCompanies + newDomains + content.substring(domEnd);
